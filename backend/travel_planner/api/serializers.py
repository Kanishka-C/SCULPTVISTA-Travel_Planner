...
class UserPreferenceSerializer(serializers.ModelSerializer):
    ...
    activities = serializers.ListField(required=False, allow_empty=True)
    health_issues = serializers.ListField(required=False, allow_empty=True)
    
    class Meta:
        model = UserPreference
        fields = [
            'id', 'departure','destination', 'budget', 'start_date','end_date', 'travel_style', 
            'activities', 'transportation', 
            'health_issues', 'created_at', 'updated_at'
        ]
